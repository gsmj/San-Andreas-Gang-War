...
from samp import (CAMERA_CUT, INVALID_PLAYER_ID, INVALID_VEHICLE_ID,
                  MAPICON_LOCAL, SPECTATE_MODE_NORMAL, AddMenuItem,
                  AddPlayerClass, AddPlayerClassEx, AddStaticPickup,
                  AddStaticVehicle, AddStaticVehicleEx, AddVehicleComponent,
                  AllowAdminTeleport, AllowInteriorWeapons,
                  AllowPlayerTeleport, ApplyActorAnimation, ApplyAnimation,
                  ...
                  BanEx, BlockIpAddress, CallNativeFunction,
                  CallRemoteFunction, CancelEdit, CancelSelectTextDraw,
                  ...
                  EnableZoneNames, ForceClassSelection, GameModeExit,
                  GameTextForAll, GameTextForPlayer, GangZoneCreate,
                  GangZoneDestroy, GangZoneFlashForAll, GangZoneFlashForPlayer,
                  GangZoneHideForAll, GangZoneHideForPlayer,
                  GangZoneShowForAll, GangZoneShowForPlayer,
                  GangZoneStopFlashForAll, GangZoneStopFlashForPlayer,
                  GetActorFacingAngle, GetActorHealth, GetActorPoolSize,
                  GetActorPos, GetActorVirtualWorld, GetAnimationName,
                  GetConsoleVarAsBool, GetConsoleVarAsInt,
                  GetConsoleVarAsString, GetGravity, GetMaxPlayers,
                  GetNetworkStats, GetObjectModel, GetObjectPos, GetObjectRot,
                  GetPlayerAmmo, GetPlayerAnimationIndex, GetPlayerArmour,
                  GetPlayerCameraAspectRatio, GetPlayerCameraFrontVector,
                  GetPlayerCameraMode, GetPlayerCameraPos,
                  GetPlayerCameraTargetActor, GetPlayerCameraTargetObject,
                  GetPlayerCameraTargetPlayer, GetPlayerCameraTargetVehicle,
                  GetPlayerCameraZoom, GetPlayerColor,
                  GetPlayerDistanceFromPoint, GetPlayerDrunkLevel,
                  GetPlayerFacingAngle, GetPlayerFightingStyle,
                  GetPlayerHealth, GetPlayerInterior, GetPlayerIp,
                  GetPlayerKeys, GetPlayerLastShotVectors, GetPlayerMenu,
                  GetPlayerMoney, GetPlayerName, GetPlayerNetworkStats,
                  GetPlayerObjectModel, GetPlayerObjectPos, GetPlayerObjectRot,
                  GetPlayerPing, GetPlayerPoolSize, GetPlayerPos,
                  GetPlayerScore, GetPlayerSkin, GetPlayerSpecialAction,
                  GetPlayerState, GetPlayerSurfingObjectID,
                  GetPlayerSurfingVehicleID, GetPlayerTargetActor,
                  GetPlayerTargetPlayer, GetPlayerTeam, GetPlayerTime,
                  GetPlayerVehicleID, GetPlayerVehicleSeat, GetPlayerVelocity,
                  GetPlayerVersion, GetPlayerVirtualWorld,
                  ...
                  IsVehicleStreamedIn, Kick, KillTimer, LimitGlobalChatRadius,
                  ...
                  NetStats_PacketLossPercent, OBJECT_MATERIAL_SIZE_256x128,
                  PlayAudioStreamForPlayer, PlayCrimeReportForPlayer,
                  PlayerPlaySound, PlayerSpectatePlayer, PlayerSpectateVehicle,
                  ...
                  PlayerTextDrawUseBox, PutPlayerInVehicle, RegisterCallback,
                  ...
                  SetSVarInt, SetSVarString, SetTeamCount, SetTimer,
